...
#   that summarise crude and fully adjusted
#   linear mixed models across all outcomes)
#   * rRespond_get_models_log (returns a table
#   that summarise crude and fully adjusted
#   logistic mixed models across all outcomes)
#   * rRespond_get_models_baselinecov (returns a list of objects
#   that summarise baseline- and fully adjusted
#   linear mixed models across all outcomes)
#   * rRespond_get_models_log_baselinecov (returns a table
#   that summarise baseline- and fully adjusted
#   logistic mixed models across all outcomes)
#   *rRespond_get_models_fem (returns a list of objects
#   that summarise baseline- and fully-adjusted
#   linear mixed models for female participants across all outcomes)
#
...
full_summary <- # output
  ...
  relocate(adj,
           ...
           conf.low,
           conf.high) %>%
  select(!c(term, contrast, null.value))
